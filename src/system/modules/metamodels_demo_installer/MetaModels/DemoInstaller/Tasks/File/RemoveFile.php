...
class RemoveFile extends FileTask
{
	...
	public function run()
	{
		...
		switch ($this->determineType())
		{
			...
			case 'l':
				...
				break;
			default:
				throw new \RuntimeException('Error, unknown file type encountered: ' . $path);
		}
	}
	...
	public function getDescription()
	{
		switch ($this->determineType())
		{
			...
			case 'l':
				...
				break;
			default:
				throw new \RuntimeException('Error, unknown file type encountered: ' . $this->filename);
				break;
		}
	}
}
