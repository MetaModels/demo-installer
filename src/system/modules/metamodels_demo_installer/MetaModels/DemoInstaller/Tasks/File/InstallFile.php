...
class InstallFile extends FileTask
{
	...
	public function run()
	{
		if (is_dir(TL_ROOT . DIRECTORY_SEPARATOR . $this->filename))
		{
			...
			{
				throw new \RuntimeException('Error creating directory: ' . TL_ROOT . DIRECTORY_SEPARATOR . $this->destination);
			}
		}
		else
		{
			...
			{
				throw new \RuntimeException('Error installing file: ' . TL_ROOT . DIRECTORY_SEPARATOR . $this->destination);
			}
		}
	}
